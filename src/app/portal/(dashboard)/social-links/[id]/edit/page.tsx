/*
  portal/social-links/[id]/edit/page.tsx — Form Edit Social Media Link
*/
...
export default async function EditSocialLinkPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const link = socialLink as SocialLink;
    ...
    <div>
      ...
      <form action={updateSocialLink.bind(null, link.id)} style={{ maxWidth: "720px", display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <input type="checkbox" name="is_active" value="true" defaultChecked={link.is_active} id="is_active" />
