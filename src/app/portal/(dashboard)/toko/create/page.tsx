    ...
    <div>
      ...
      <form action={createProduct} style={{ maxWidth: "720px", display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <label style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <input type="text" name="label" placeholder="Best seller, Terlaris" style={{ padding: "12px 16px", background: "var(--input-bg)", border: "1px solid var(--input-border)", color: "var(--text-primary)", borderRadius: "var(--radius-md)", fontSize: "15px" }} />
        </label>
        ...
        <label style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <span style={{ fontSize: "12px", color: "var(--text-secondary)" }}>Format: JPG, PNG, WebP. Maks 5MB.</span>
        </label>

        <label style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <span style={{ fontSize: "12px", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "1px" }}>Link Tokopedia (opsional)</span>
          <input type="url" name="tokopedia_url" placeholder="https://tokopedia.com/..." style={{ padding: "12px 16px", background: "var(--input-bg)", border: "1px solid var(--input-border)", color: "var(--text-primary)", borderRadius: "var(--radius-md)", fontSize: "15px" }} />
        </label>

        <label style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <span style={{ fontSize: "12px", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "1px" }}>Link Shopee (opsional)</span>
          <input type="url" name="shopee_url" placeholder="https://shopee.co.id/..." style={{ padding: "12px 16px", background: "var(--input-bg)", border: "1px solid var(--input-border)", color: "var(--text-primary)", borderRadius: "var(--radius-md)", fontSize: "15px" }} />
        </label>
