    ...
    <section id="cases" className="animate-on-scroll" style={{ padding: "96px 56px", background: "rgba(255,255,255,0.02)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "32px" }}>
        {caseStudies.map((cs, index) => (
          <div key={cs.id} className="grid-item hover-lift hover-glow" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", padding: "40px", animationDelay: `${index * 0.15}s` }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "24px" }}>
              ...
              <div style={{ position: "relative", borderRadius: "8px", overflow: "hidden", background: "rgba(0,0,0,0.4)", minHeight: "200px" }}>
