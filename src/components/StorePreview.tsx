...
export default function StorePreview() {
  ...
  return (
    <section style={{ padding: "80px 56px", background: "var(--section-bg-alt)" }}>
      <div style={{ maxWidth: "1080px", margin: "0 auto" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", marginBottom: "42px" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-primary)", fontSize: "var(--text-4xl)", fontWeight: 700, color: "var(--text-primary)", textAlign: "center", maxWidth: "720px" }}>
            Belanja pangan asli langsung dari mitra lokal, terhubung dengan Shopee.
          </h2>
          <p style={{ maxWidth: "720px", color: "var(--text-secondary)", lineHeight: 1.8, textAlign: "center", fontSize: "var(--text-lg)" }}>
          ...
          {products.map((product) => (
            ...
            >
              ...
              >
                ...
                <h3 style={{ fontSize: "var(--text-2xl)", fontWeight: 700, color: "var(--text-primary)", marginBottom: "14px" }}>
                  {product.name}
                </h3>
                <p style={{ color: "var(--text-secondary)", lineHeight: 1.8, marginBottom: "26px" }}>
                  {product.description}
                </p>
