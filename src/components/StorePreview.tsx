...
const products = [
  {
    ...
    description: "Dari petani asli, tanpa pestisida, langsung siap masak.",
    price: "Rp 85.000/kg",
    label: "Best seller",
  },
  {
    name: "Gula Aren Tradisional",
    description: "Rasa alami, tekstur lembut, cocok untuk minuman dan kue.",
    price: "Rp 45.000/350g",
    label: "Terlaris",
  },
  {
    name: "Kopi Robusta Nusantara",
    description: "Aroma kuat, biji pilihan, dukung petani lokal.",
    price: "Rp 75.000/250g",
    label: "Asli Indonesia",
  },
];
